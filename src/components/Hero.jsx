    ...
    <section className="relative w-full h-screen bg-cover bg-center" style={{ backgroundImage: `url(${HeroBackground})` }}>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          <div className="mt-6 flex space-x-4">
            <a href="#" className="px-6 py-3 bg-transparent border border-yellow-400 text-[#ffe67b] rounded-lg text-lg md:text-xl hover:bg-[#ffe67b] hover:text-black grow vertical-center transition duration-300 font-bold">
              DISCOVER
            </a>
